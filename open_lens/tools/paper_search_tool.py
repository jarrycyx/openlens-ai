...
class SearchArxivTool(BaseTool):
    ...
    description: str = "Search for academic papers on arXiv.org based on a query string. Returns paper metadata including title, authors, abstract, and other details."
...
class SearchPubMedTool(BaseTool):
    ...
    description: str = "Search for academic papers on PubMed based on a query string. Returns paper metadata including title, authors, abstract, and other details."
...
class SearchBioRxivTool(BaseTool):
    ...
    description: str = "Search for academic papers on bioRxiv (biology preprint server) based on a query string. Returns paper metadata including title, authors, abstract, and other details."
...
class SearchMedRxivTool(BaseTool):
    ...
    description: str = "Search for academic papers on medRxiv (medical preprint server) based on a query string. Returns paper metadata including title, authors, abstract, and other details."
...
class SearchGoogleScholarTool(BaseTool):
    ...
    description: str = "Search for academic papers on Google Scholar based on a query string. Returns paper metadata including title, authors, abstract, and other details."
...
class SearchIACRTool(BaseTool):
    ...
    description: str = "Search for academic papers on IACR ePrint Archive (International Association for Cryptologic Research) based on a query string. Returns paper metadata including title, authors, abstract, and other details."
...
class SearchSemanticTool(BaseTool):
    ...
    description: str = "Search for academic papers on Semantic Scholar based on a query string with optional year filtering. Returns paper metadata including title, authors, abstract, citation count, and other details."
...
class DownloadSemanticInput(BaseModel):
    ...
    paper_id: str = Field(..., description="Semantic Scholar paper ID, Paper identifier in one of the following formats: "
...
class ReadArxivPaperTool(BaseTool):
    ...
    description: str = "Read and extract text content from an arXiv paper PDF. The tool will first download the paper if it doesn't exist locally, then extract the text content."
...
class ReadBioRxivPaperTool(BaseTool):
    ...
    description: str = "Read and extract text content from a bioRxiv paper PDF. The tool will first download the paper if it doesn't exist locally, then extract the text content."
...
class ReadMedRxivPaperTool(BaseTool):
    ...
    description: str = "Read and extract text content from a medRxiv paper PDF. The tool will first download the paper if it doesn't exist locally, then extract the text content."
...
class ReadIACRPaperTool(BaseTool):
    ...
    description: str = "Read and extract text content from an IACR ePrint paper PDF. The tool will first download the paper if it doesn't exist locally, then extract the text content."
...
class ReadSemanticPaperTool(BaseTool):
    ...
    description: str = "Read and extract text content from a Semantic Scholar paper. The tool will first download the paper if it doesn't exist locally, then extract the text content."
