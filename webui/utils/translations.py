...
TRANSLATIONS = {
    ...
    "eng": {
        ...
        "manage_and_select_config": "Manage & Select Config",
        "select_config": "Select Config",
        "select_template": "Select Template",
        "set_as_current_config": "Set as Current Config",
        "set_as_current_config_help": "Automatically set this config as the current one after saving",
        "minimal_template": "Minimal Template",
        "full_template": "Full Template",
        "edit_config": "Edit Config",
        "config_help": "Edit the TOML configuration below. Click Save to save your custom configuration.",
        "config_name": "Config Name",
        "config_name_placeholder": "(e.g., my-custom-config)",
        "save": "Save",
        "config_name_required": "Please enter a config name",
        "config_name_invalid": "Config name contains invalid characters",
        "config_saved": "Config saved successfully",
        "config_save_error": "Failed to save config",
        "no_custom_configs": "No custom configs yet",
        ...
        "select": "Select",
        "clear": "Clear",
        "config_selected": "Config selected successfully",
        "config_cleared": "Config cleared successfully",
        "config_deleted": "Config deleted successfully",
        "apply_config_note": "The selected config will be applied when starting new research tasks.",
        "back": "Back",
        "using_custom_config": "Using Custom Config",
        ...
        "dataset_source_help": "Please select an appropriate dataset",
        "dataset_alert": "Please make sure the selected / uploaded dataset {dataset} can support the research question. Otherwise, the research results will be completely unreliable.",
        "dataset_alert_title": "Dataset Alert",
        "dataset_cancel": "Cancel",
        "dataset_confirm": "Confirm",
...
🌟 Find this useful? Star us on [GitHub](https://github.com/jarrycyx/openlens-ai)!
    ...
    "chs": {
        ...
        "custom_config": "自定义配置",
        "create_config": "创建配置",
        "manage_and_select_config": "管理与选择配置",
        "select_config": "选择配置",
        "select_template": "选择模板",
        "set_as_current_config": "设置为当前配置",
        "set_as_current_config_help": "保存后自动将此配置设为当前配置",
        "minimal_template": "精简模板",
        "full_template": "完整模板",
        "edit_config": "编辑配置",
        "config_help": "在下方编辑TOML配置，点击保存以保存您的自定义配置。",
        "config_name": "配置名称",
        "config_name_placeholder": "(例如：my-custom-config)",
        "save": "保存",
        "config_name_required": "请输入配置名称",
        "config_name_invalid": "配置名称包含无效字符",
        "config_saved": "配置保存成功",
        "config_save_error": "保存配置失败",
        "no_custom_configs": "暂无自定义配置",
        "created_at": "创建时间",
        "delete": "删除",
        "view": "查看",
        "current_config": "当前配置",
        ...
        "select": "选择",
        "clear": "清除",
        "config_selected": "配置选择成功",
        "config_cleared": "配置已清除",
        "config_deleted": "配置删除成功",
        "apply_config_note": "选中的配置将在启动新的研究任务时应用。",
        "back": "返回",
        "using_custom_config": "正在使用自定义配置",
        ...
        "dataset_source_help": "请选择合适的数据集",
        "dataset_alert": "请确保所选择或上传的数据集{dataset}能够支持该研究问题，否则研究结果会完全不可靠。",
        "dataset_alert_title": "数据集警告",
        "dataset_cancel": "取消",
        "dataset_confirm": "确认",
