...
TRANSLATIONS = {
    ...
    "eng": {
        ...
        "dataset_alert": "Please make sure the selected dataset {dataset} can support the research question. Otherwise, the research results will be completely unreliable.",
...
🌟 Find this useful? Star us on [GitHub](https://github.com/jarrycyx/openlens-ai)!
    ...
    "chs": {
        ...
        "dataset_alert": "请确保所选数据集{dataset}能够支持该研究问题，否则研究结果会完全不可靠。",
