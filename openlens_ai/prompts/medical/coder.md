...
- Plot the results to figures if possible to better illustrate the findings. DO NOT add long texts on the figures, e.g., technical specifications, methodology details, etc.
