...
- Only write code, reports and save results in the designated directory (/workspace/subtask_XX), do not write code outside the directory (i.e., DO NOT CREATE FILES IN /workspace or its subdirectories).